...
$classes = ($active ?? false)
            ? 'relative flex items-center justify-between w-full py-1 rounded text-white bg-gray-700'
            : 'relative flex items-center justify-between w-full py-1 rounded hover:text-white hover:bg-gray-700';
@endphp
<li class="relative">
