        ...
        <div class="px-6 py-4">
            ...
            <div class="mt-5">
                <div>
                    ...
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            name="medicine.market_id"
                            label="Market"
                            wire:model="medicine.market_id"
                        >
                            <option value="null" disabled>Please select the Market</option>
            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.manufacturer_medicines.inputs.name')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.manufacturer_medicines.inputs.expiration_date')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.manufacturer_medicines.inputs.code')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.manufacturer_medicines.inputs.cc')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.manufacturer_medicines.inputs.cost')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.manufacturer_medicines.inputs.market_id')
                    </th>
                    <th></th>
                </tr>
            </thead>
